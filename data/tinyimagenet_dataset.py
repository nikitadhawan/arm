...
class ImageNetDataset(Dataset):
    ...
    def __init__(self, split, root_dir):
        if split == 'train':
            self.root_dir = Path(root_dir) / 'Tiny-ImageNet-C-train/'
...
#        albumentations.RandomCrop(60, 60, always_apply=True),
#        albumentations.Resize(height=64, width=64, interpolation=1, p=1, always_apply=True),
